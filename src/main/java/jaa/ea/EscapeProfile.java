...
import static jaa.ea.EliminationParser.toMapOfEliminations;
...
public class EscapeProfile
{
    public static void main(String ... argv) throws IOException {
        ...
        Map<String, List<EliminatedAllocation>> eliminated = toMapOfEliminations(new EliminationParser().parse(lines));
